...
bool LTexture::LoadFromRenderedText(std::string textureText,TTF_Font *g_Font, SDL_Color textColor, SDL_Renderer *g_Renderer)
{
	Free();
...
bool LTexture::LoadFromFile(std::string path, SDL_Renderer *g_Renderer)
{
	Free();
...
void LTexture::Render(int x, int y, SDL_Renderer* g_Renderer, SDL_Rect* clip)
{
	...
	SDL_RenderCopy(g_Renderer, mTexture, clip, &renderSpace);
}
