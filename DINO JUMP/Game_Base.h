...
#define SPEED_INCREASEMENT 1.25
...
const std::string WINDOW_TITLE = "Huy Anh-UET game";
...
const double LAYER_6_SPEED = 2.5;
const double LAYER_7_SPEED = 5;
const double LAYER_8_SPEED = 5;
const double LAYER_9_SPEED = 1.75;
